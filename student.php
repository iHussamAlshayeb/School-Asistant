...
<ul class="navbar-nav">
	...
	<li class="nav-item active"><a class="nav-link" href="student.php"> بيانات الطالبة </a></li>
...
<br>
<p>للبحث عن بيانات الطالبة (ادخل الرقم 
			الاكاديمي)
</p>
            
    <form method="post" action="student.php">
    <input type="text" placeholder="الرقم الاكاديمي" name="academic_num" required> 
    <input name="std_info" id="std_info" class="btn btn-primary" type="submit" value="بحث">    
