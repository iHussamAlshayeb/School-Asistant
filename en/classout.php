...
<br>
   <p>
              To Print Class Card [ Enter Class Number ]

            </p>
            
            
              <form method="post" action="classout.php">
            <input type="text" placeholder="Class Number" required name="classid" id="classid">
            <input type="submit" class="btn btn-primary" value="Search" name="printclass" id="printclass">
                </form>
            <br>
                                    <div id="GFG"> 
...
<input class="btn btn-success" onclick="printDiv()" value="Print">
     ...
     <script> 
        function printDiv() { 
            ...
            a.document.write('<body > <h1>Class Information:<br>'); 
