...
<ul class="navbar-nav">
    ...
    <li class="nav-item"><a class="nav-link" href="../index.php">عربي</a></li>
		...
		<center>
            ...
            <br><br>
            <a href="classout.php" style="text-decoration: none;"> <button class="btn btn-outline-success btn-lg btn-block"> Print Class Card</button></a>
        <br>
            <a href="studentout.php" style="text-decoration: none;"> <button class="btn btn-outline-success btn-lg btn-block">Print Student Card</button></a>
