...
<ul class="navbar-nav">
	...
	<li class="nav-item active"><a class="nav-link" href="student.php">Student Information</a></li>
...
<br>
<p>
    To Search in Student Information [ Enter Acadimic Number ]
</p>
            
    <form method="post" action="student.php">
    <input type="text" placeholder="Acadimic Number " name="academic_num" required> 
    <input name="std_info" id="std_info" class="btn btn-primary" type="submit" value="Search">    
