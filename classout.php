...
<br>
   <p>
               لطباعة بطاقات خروج الطالبات (ادخل اسم الصف)

            </p>
            
            
              <form method="post" action="classout.php">
            <input type="text" placeholder="ادخل الصف " required name="classid" id="classid">
            <input type="submit" class="btn btn-primary" value="بحث" name="printclass" id="printclass">
                </form>
            <br>
                        <div id="GFG"> 
...
<input class="btn btn-success" onclick="printDiv()" value="اطبع">
     ...
     <script> 
        function printDiv() { 
            ...
            a.document.write('<body > <h1>معلومات الفصل<br>'); 
