...
<ul class="navbar-nav">
    ...
    <li class="nav-item"><a class="nav-link" href="en/index.php">English</a></li>
		...
		<center>
            <br>
<p>
               لطباعة بطاقة خروج طالبة واحدة (ادخل الرقم الاكاديمي)

            </p>
            
            <form method="post" action="studentout.php">
            <input type="text" placeholder="ادخل الرقم الاكاديمي" required id="acc_id" name="acc_id">
            <input type="submit" class="btn btn-primary" value="بحث" name="printstudent" id="printstudent">
            </form>
...
<input class="btn btn-success" onclick="printDiv()" value="اطبع">
     ...
     <script> 
        function printDiv() { 
            ...
            a.document.write('<body > <h1>معلومات الطالبة<br>'); 
